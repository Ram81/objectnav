...
# ! For debugging, insert episode ids here.
WHITELIST = [(152, "2azQ1b91cZZ")]
WHITELIST = []
...
class ObjectNavDatasetV1(PointNavDatasetV1):
    ...
    def from_json(
        ...
        for i, episode in enumerate(deserialized["episodes"]):
            ...
            if len(WHITELIST) == 0 or (len(WHITELIST) > 0 and
            (int(episode.episode_id), episode.scene_id.split('/')[-2]) in WHITELIST):
