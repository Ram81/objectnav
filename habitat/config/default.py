...
# -----------------------------------------------------------------------------
# COVERAGE REWARD MEASUREMENT
# -----------------------------------------------------------------------------
# * Note that the config name, i.e. "COVERAGE" is what's referenced in task_cfg
# and .TYPE == the registered class name
# I'm not too sure why these are under task config
_C.TASK.COVERAGE_REWARD = CN()
_C.TASK.COVERAGE_REWARD.TYPE = "CoverageExplorationReward"
_C.TASK.COVERAGE_REWARD.REWARD = 0.25
_C.TASK.COVERAGE_REWARD.ATTENUATION = 0.995
_C.TASK.COVERAGE_REWARD.VISIT_EXP = 1
# Dup-ed from RL config (in `habitat_baselines.config`)

# -----------------------------------------------------------------------------
# OBJECTNAV REWARD MEASUREMENT
# -----------------------------------------------------------------------------
_C.TASK.OBJNAV_REWARD = CN()
_C.TASK.OBJNAV_REWARD.TYPE = "ObjectNavSparseReward"
_C.TASK.OBJNAV_REWARD.SUCCESS_REWARD = 2.5
# Dup-ed from RL config (in `habitat_baselines.config`)

# -----------------------------------------------------------------------------
# OBJECTNAV REWARD MEASUREMENT DUPLICATE
# -----------------------------------------------------------------------------
_C.TASK.OBJNAV_REWARD_A = _C.TASK.OBJNAV_REWARD.clone() # Where is this pulled from?
_C.TASK.OBJNAV_REWARD_A.TYPE = "ObjectNavSparseRewardA"

# -----------------------------------------------------------------------------
# OBJECTNAV D2G REWARD MEASUREMENT
# -----------------------------------------------------------------------------
_C.TASK.D2G_REWARD = CN()
_C.TASK.D2G_REWARD.TYPE = "DistanceToGoalReward"
_C.TASK.D2G_REWARD.SUCCESS_REWARD = 2.5
...
# -----------------------------------------------------------------------------
# # GOAL_OBJECT_VISIBLE MEASUREMENT
# -----------------------------------------------------------------------------
_C.TASK.GOAL_OBJECT_VISIBLE_PIXELS = CN() # nb: this is fraction of view, not pixels
_C.TASK.GOAL_OBJECT_VISIBLE_PIXELS.TYPE = "GoalObjectVisible"

# -----------------------------------------------------------------------------
# # REGION_LEVEL_INFO MEASUREMENT
# -----------------------------------------------------------------------------
_C.TASK.REGION_LEVEL_INFO = CN() # nb: this is fraction of view, not pixels
_C.TASK.REGION_LEVEL_INFO.TYPE = "RegionLevelInfo"

# -----------------------------------------------------------------------------
# # OBJECT_NAV_REWARD MEASUREMENT
# -----------------------------------------------------------------------------
# _C.TASK.OBJNAV_REWARD = CN()
# _C.TASK.OBJNAV_REWARD.TYPE = "ObjectNavReward"
# _C.TASK.OBJNAV_REWARD.MODE = "DISTANCE_TO_GOAL_WHEN_VISIBLE_OTHERWISE_EXPLORE"
# # DISTANCE_TO_GOAL, EXPLORATION, SUCCESS_REWARD
# _C.TASK.OBJNAV_REWARD.GOAL_SEEN_THRESHOLD = 0.05 # ! Amp this up
# _C.TASK.OBJNAV_REWARD.GOAL_SEEN_REWARD = 3
# _C.TASK.OBJNAV_REWARD.SUCCESS_REWARD = 10
# _C.TASK.OBJNAV_REWARD.EXP_REWARD_COEF = 10
# _C.TASK.OBJNAV_REWARD.SLACK_REWARD = -0.01
# -----------------------------------------------------------------------------
# SIMULATOR
# -----------------------------------------------------------------------------
_C.SIMULATOR = CN()
